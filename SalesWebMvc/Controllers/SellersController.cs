...
namespace SalesWebMvc.Controllers
{
    public class SellersController : Controller
    {
        ...
        public async Task<IActionResult> Delete(int? id) // ? inidica valor opcional
        {
            if (id == null)
            {
            ...
            var obj = await _sellerService.FindByIdAsync(id.Value); //id é nullable, por isso é necessário colocar o atributo Value
            if (obj == null)
            {
