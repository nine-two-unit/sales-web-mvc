...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Barbara Butterfield", "barb@email.com", new DateTime(1948, 7, 2), 3000.0, d1);
            Seller s2 = new Seller(2, "Amanda Jones", "amanda@email.com", new DateTime(1997, 5, 20), 1000.0, d1);
            Seller s3 = new Seller(3, "Carl Cole", "carlc@email.com", new DateTime(1948, 7, 3), 3000.0, d3);
            Seller s4 = new Seller(4, "Kim Kobayashi", "kim@email.com", new DateTime(1948, 9, 7), 2500.0, d3);
            Seller s5 = new Seller(5, "Natalie Nolan", "nnolan@email.com", new DateTime(1948, 9, 15), 4000.0, d4);
            Seller s6 = new Seller(6, "Alex Adrians", "adrians@email.com", new DateTime(1948, 7, 1), 4500.0, d2);

            SalesRecord r1 = new SalesRecord(1, new DateTime(2020, 09, 25), 12000.0, SalesStatus.Billed, s1);
